...
/**
 * Application event published when a job mutation commits and the active-job
 * matching corpus needs to be refreshed.
 *
 * Publishing this event rather than calling
 * MatchingCorpusService#rebuildFromRepository() directly has two benefits:
